class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:type_of_event, :what, :why, :when, :where, :mode_of_transport, :flight_num, :flight_time, :flight_date, :accomodation_type, :accomodation_address, :accomodation_checkin, :accomodation_checkout, :story_id, :long, :lat, eventphotos_attributes: [:photo])
    end
